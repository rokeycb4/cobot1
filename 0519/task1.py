...
def pulloff():
    ...
    movel([0,0,0,  0,5,0], 0.5,0.5, mod=1)
    wait(1)
    
    force_control_off()
    movel([0,0,0,  0,-5,0], 1,1, mod=1)
...
p1 = posx(375.97, -137.23, 19.76, 160.81, -180, 161.33)
p2 = posx(518.75, 21.5, 30, 0.65, -179.96, -0.51)     #레고1 (힘제어 시작위치니까 살짝 위에 있어야됨)
